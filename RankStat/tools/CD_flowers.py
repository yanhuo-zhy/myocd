...
class OxfordFlowers(Flowers102):
    ...
    def __init__(self, root=oxford_flowers_root, split='train', transform=None, target_transform=None, download=False):
        ...
        super(OxfordFlowers, self).__init__(root=root, split=split, transform=transform, target_transform=target_transform, download=download)
...
def get_oxford_flowers_datasets(train_transform, 
    ...
    whole_training_set = OxfordFlowers(root=oxford_flowers_root, transform=train_transform)
    ...
    whole_test_dataset = OxfordFlowers(root=oxford_flowers_root, transform=test_transform, split='test')
