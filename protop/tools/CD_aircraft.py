...
aircraft_root = '/wang_hp/zhy/data/fgvc_aircraft'
...
class FGVCAircraft(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return sample, target, self.uq_idxs[index], self.uq_idxs[index]
...
def get_aircraft_datasets(train_transform, test_transform, train_classes=range(50), prop_train_labels=0.8,
    ...
    whole_test_dataset = FGVCAircraft(root=aircraft_root, transform=test_transform, split='test')
