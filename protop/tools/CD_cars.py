...
def get_scars_datasets(train_transform, test_transform, train_classes=range(160), prop_train_labels=0.8, car_root=None,
    ...
    whole_test_dataset = CarsDataset(data_dir=car_root, transform=test_transform, train=False)
