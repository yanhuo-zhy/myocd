...
def get_food_101_datasets(train_transform, 
    ...
    whole_training_set = Food101_Base(root=food_101_root, transform=train_transform)
    ...
    whole_test_dataset = Food101_Base(root=food_101_root, transform=test_transform, split='test')
