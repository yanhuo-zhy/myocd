...
from config import oxford_pet_root
...
def get_oxford_pets_datasets(train_transform, 
    ...
    whole_training_set = OxfordPetDataset(root=oxford_pet_root, transform=train_transform)
    ...
    test_dataset = OxfordPetDataset(root=oxford_pet_root, transform=test_transform, split='test')
